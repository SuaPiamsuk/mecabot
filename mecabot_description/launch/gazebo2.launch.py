...
def generate_launch_description():
    ...
    pkg_irobot_create_description = get_package_share_directory('mecabot_description')
    ...
    # gz_resource_path = SetEnvironmentVariable(name='GAZEBO_MODEL_PATH', value=[EnvironmentVariable('GAZEBO_MODEL_PATH',default_value=''),'/usr/share/gazebo-11/models/:',str(Path(pkg_irobot_create_description).parent.resolve())])
    
    # gz_resource_path = SetEnvironmentVariable('GAZEBO_MODEL_PATH',os.path.join(pkg_irobot_create_description,'share') )
