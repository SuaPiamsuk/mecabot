...
def generate_launch_description():
    ...
    world_path = PathJoinSubstitution(
        [FindPackageShare("mecabot_gazebo"), "worlds", "basic.world"]
    )

    description_launch_path = PathJoinSubstitution(
        [FindPackageShare('mecabot_description'), 'launch', 'test2.launch.py']
    )

    # urdf = os.path.join(get_package_share_directory('mecabot_description'), 'urdf'+'/', 'mecabot.urdf')
